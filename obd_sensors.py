...
#
# Modified by Bernardo Plaza on PFC-BPT project
###########################################################################
...
def maf(code):
    ...
    return code #* 0.00132276 default gr/s 
...
def intake_m_pres(code): # in kPa
    code = hex_to_int(code)
    return code #/ 0.14504 libra por pulgada cuadrada
...
SENSORS = [
    ...
    Sensor("short_term_fuel_trim_1", "S-T Fuel Trim 1"                , "0106" , fuel_trim_percent,"%"      ),
    Sensor("long_term_fuel_trim_1" , "L-T Fuel Trim 1"                , "0107" , fuel_trim_percent,"%"      ),
    Sensor("short_term_fuel_trim_2", "S-T Fuel Trim 2"                , "0108" , fuel_trim_percent,"%"      ),
    Sensor("long_term_fuel_trim_2" , "L-T Fuel Trim 2"                , "0109" , fuel_trim_percent,"%"      ),
